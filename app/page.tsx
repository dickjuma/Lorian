    ...
    <main className="scroll-smooth text-gray-900">
      ...
      >
        ...
        <div className="mt-10 flex gap-4">
          <a
            href="#services"
            className="px-8 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition shadow-lg"
          >
            Our Services
          </a>
          <a
            href="#contact"
            className="px-8 py-3 border border-green-400 rounded-xl hover:bg-green-400 hover:text-black transition"
          >
            Contact Us
          </a>
        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              {
                title: "Mission",
                text: "Deliver innovative, safe, and sustainable engineering solutions while prioritizing quality, integrity, and teamwork."
              },
              {
                title: "Vision",
                text: "To be a well-recognized structural engineering firm in Kenya, renowned for excellence and creativity."
              },
              {
                title: "Core Values",
                text: "Quality • Innovation • Safety • Integrity • Client Satisfaction"
              }
            ].map((item, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl border bg-gradient-to-br from-white to-gray-50 hover:shadow-lg transition"
              >
          ...
          {[
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Reliable, safe, and professional engineering solutions tailored to your project needs.
              </p>
            </motion.div>
          ))}
        </div>
      ...
      <section id="projects" className="py-28 max-w-6xl mx-auto px-6 space-y-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="p-6 rounded-2xl border bg-gradient-to-br from-white to-gray-50 hover:border-green-600 transition"
            >
              <h3 className="font-bold mb-2">{project}</h3>
              <p className="text-gray-600 text-sm">
                Engineering excellence delivered with precision and safety.
              </p>
            </div>
          ))}
        </div>
      ...
      <section id="team" className="py-28 bg-gray-50 text-center px-6 space-y-10">
        ...
        <div className="flex justify-center mb-12">
          <img src="/Lorian.png" alt="BiLOR Logo" className="h-16 w-16" />
        </div>
        ...
        <div className="max-w-6xl mx-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          {teamMembers.map((member, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 shadow-lg border hover:shadow-2xl transition relative overflow-hidden"
            >
      ...
      <section id="contact" className="py-28 max-w-4xl mx-auto px-6 space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="text-gray-700 space-y-3 text-sm">
            ...
            <p>
              <strong>Location:</strong> Hillside Estate, Opposite Kenya Creameries Company (KCC), Kapsoya, Eldoret, Uasin Gishu County
            </p>
            <p className="pt-4 text-gray-600 italic">
              Instagram · TikTok · X<br />
              bilor engineering designs ltd
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-black text-white text-center py-8">
        <p className="text-gray-300">
          © 2025 BiLOR Civil & Structural Engineering Design Ltd
        </p>
